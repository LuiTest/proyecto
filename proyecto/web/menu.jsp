...
<html>
    ...
    <body id="imagenLogin" class="index" style="background-repeat: repeat">
        ...
        <label class="ui-state-default ui-corner-all" id="User-FullName"><%= user.getFirstName() + user.getLastName()%></label>

        <button class="ui-button ui-button-text ui-corner-all ui-state-active">Log out</button>
